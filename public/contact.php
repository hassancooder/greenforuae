    ...
    <div class="md:flex mt-6 mb-10 md:space-x-10 items-start z-1 max-w-5xl gap-4">
        <div class="mt-6 md:w-3/12 md:mt-0">
            <iframe
                ...
                allowfullscreen=""
                loading="lazy"
                class="w-full h-[280px] md:h-[370px]"
                referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
        <form onsubmit="handleFormSubmit(event,'contactform','.contact-form-btn-spinner','.contact-form-btn-text','.contact-form-response-text')" class="md:w-6/12 mt-6 md:mt-0">
            ...
            <div class="mt-4">
                <div class="flex items-center justify-start">
                    <button type="submit" class="inline-flex items-center block rounded-full bg-primary center text-sm font-semibold text-bgPrimary shadow-sm hover:bg-primary/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary px-3.5 py-2.5">
                        <svg class="w-5 h-5 mx-auto text-bgPrimary animate-spin contact-form-btn-spinner hidden" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
