    ...
    <div class="mx-auto h-2/4 max-w-2xl mt-10 py-32 sm:py-48 lg:py-36">
        <div class="text-center">
            <h1 class="text-4xl font-bold tracking-tight text-textPrimary sm:text-6xl">
                <span class="lang-english hidden">Our Services</span>
                <span class="lang-arabic">خدماتنا</span>
            </h1>
            <p class="mt-6 text-lg leading-8 text-textSecondary">
                <span class="flex justify-center items-center">
                    ...
                    echo '<span class="lang-arabic">الرئيسية / خدماتنا</span>';
                    ?>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-6xl mx-auto">
        <div class="py-2 px-3 bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg border border-yellow-300">
            <p class="font-semibold text-yellow-600">
                <span class="lang-english hidden">Project Management</span>
                <span class="lang-arabic">إدارة المشاريع</span>
            </p>
        </div>
        <div class="py-2 px-3 bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg border border-yellow-300">
            <p class="font-semibold text-yellow-600">
                <span class="lang-english hidden">Architectural Design</span>
                <span class="lang-arabic">التصميم المعماري</span>
            </p>
        </div>
        <div class="py-2 px-3 bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg border border-yellow-300">
            <p class="font-semibold text-yellow-600">
                <span class="lang-english hidden">General Contracting</span>
                <span class="lang-arabic">المقاولات العامة</span>
            </p>
        </div>
        <div class="py-2 px-3 bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg border border-yellow-300">
            <p class="font-semibold text-yellow-600">
                <span class="lang-english hidden">Renovations & Fit-Outs</span>
                <span class="lang-arabic">التجديدات والتشطيبات</span>
            </p>
        </div>
        <div class="py-2 px-3 bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg border border-yellow-300">
            <p class="font-semibold text-yellow-600">
                <span class="lang-english hidden">Consulting Services</span>
                <span class="lang-arabic">خدمات الاستشارات</span>
            </p>
        </div>
        <div class="py-2 px-3 bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg border border-yellow-300">
            <p class="font-semibold text-yellow-600">
                <span class="lang-english hidden">Villa Construction</span>
                <span class="lang-arabic">بناء الفلل</span>
            </p>
        </div>
        <div class="py-2 px-3 bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg border border-yellow-300">
            <p class="font-semibold text-yellow-600">
                <span class="lang-english hidden">Muhammad Bin Rashid Housing Establishment Works</span>
                <span class="lang-arabic">أعمال مؤسسة محمد بن راشد للإسكان</span>
            </p>
        </div>
        <div class="py-2 px-3 bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg border border-yellow-300">
            <p class="font-semibold text-yellow-600">
                <span class="lang-english hidden">Villa Maintenance & Modifications</span>
                <span class="lang-arabic">صيانة الفلل والتعديلات</span>
            </p>
        </div>
        <div class="py-2 px-3 bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg border border-yellow-300">
            <p class="font-semibold text-yellow-600">
                <span class="lang-english hidden">Renovation, Tiling & Painting</span>
                <span class="lang-arabic">التجديد، والبلاط، والدهان</span>
            </p>
        </div>
        <div class="py-2 px-3 bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg border border-yellow-300">
            <p class="font-semibold text-yellow-600">
                <span class="lang-english hidden">Gypsum Partitions & Ceilings</span>
                <span class="lang-arabic">تقسيمات وأسقف الجبس</span>
            </p>
        </div>
        <div class="py-2 px-3 bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg border border-yellow-300">
            <p class="font-semibold text-yellow-600">
                <span class="lang-english hidden">Interior Design & Fit-Outs</span>
                <span class="lang-arabic">التصميم الداخلي والتشطيبات</span>
            </p>
        </div>
        <div class="py-2 px-3 bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg border border-yellow-300">
            <p class="font-semibold text-yellow-600">
                <span class="lang-english hidden">Warehouse Construction</span>
                <span class="lang-arabic">بناء المستودعات</span>
            </p>
        </div>
        <div class="py-2 px-3 bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg border border-yellow-300">
            <p class="font-semibold text-yellow-600">
                <span class="lang-english hidden">Aluminium & Glazing Works</span>
                <span class="lang-arabic">أعمال الألمنيوم والزجاج</span>
            </p>
        </div>
        <div class="py-2 px-3 bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg border border-yellow-300">
            <p class="font-semibold text-yellow-600">
                <span class="lang-english hidden">Electrical, Plumbing & AC Works</span>
                <span class="lang-arabic">أعمال الكهرباء والسباكة والتكييف</span>
            </p>
        </div>
        <div class="py-2 px-3 bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg border border-yellow-300">
            <p class="font-semibold text-yellow-600">
                <span class="lang-english hidden">Dubai Municipality Permits</span>
                <span class="lang-arabic">تصاريح بلدية دبي</span>
            </p>
        </div>
    </div>
...
<div class="max-w-7xl mx-auto px-5 my-16" id="porfolio">
    <div class="flex flex-col justify-center items-center">
        <h1 class="text-4xl md:text-5xl font-bold tracking-tight text-textPrimary text-left w-full flex justify-between">
            <span class="lang-english hidden">GreenFort Has Completed Various Projects in the Following Dubai's Communities</span>
...
<div class="py-12 mt-20" data-aos="fade-up" data-aos-duration="800">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-5xl lg:text-center flex flex-col justify-center items-center">
            <h1 class="text-4xl md:text-5xl font-bold tracking-tight text-textPrimary text-center">
                <span class="lang-english hidden">Quality Assurance</span>
                <span class="lang-arabic">ضمان الجودة</span>
            </h1>
        </div>
            ...
            <div class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
                ...
                <div class="relative ps-16 rtl:pe-16 rtl:ps-0" data-aos="fade-right" data-aos-duration="800">
                    <div class="text-base font-semibold leading-7 text-textPrimary flex items-center">
                        ...
                        <span class="lang-english hidden">Comprehensive Quality Control</span>
                        <span class="lang-arabic">رقابة الجودة الشاملة</span>
                    </div>
                    <div class="mt-2 text-base leading-7 text-textSecondary lang-english hidden">
                        Our projects undergo rigorous quality control processes to ensure that every aspect meets the highest standards.
                    </div>
                    <div class="mt-2 text-base leading-7 text-textSecondary lang-arabic">
                ...
                <div class="relative ps-16 rtl:pe-16 rtl:ps-0" data-aos="fade-right" data-aos-duration="800" data-aos-delay="100">
                    <div class="text-base font-semibold leading-7 text-textPrimary flex items-center">
                        ...
                        <span class="lang-english hidden">Expert Quality Assurance Team</span>
                        <span class="lang-arabic">فريق ضمان الجودة الخبير</span>
                    </div>
                    <div class="mt-2 text-base leading-7 text-textSecondary lang-english hidden">
                ...
                <div class="relative ps-16 rtl:pe-16 rtl:ps-0" data-aos="fade-left" data-aos-duration="800">
                    <div class="text-base font-semibold leading-7 text-textPrimary flex items-center">
                        ...
                        <span class="lang-english hidden">Regular Audits and Assessments</span>
                        <span class="lang-arabic">عمليات تدقيق وتقييم منتظمة</span>
                    </div>
                    <div class="mt-2 text-base leading-7 text-textSecondary lang-english hidden">
                ...
                <div class="relative ps-16 rtl:pe-16 rtl:ps-0" data-aos="fade-left" data-aos-duration="800" data-aos-delay="100">
                    <div class="text-base font-semibold leading-7 text-textPrimary flex items-center">
                        ...
                        <span class="lang-english hidden">Commitment to Continuous Improvement</span>
                        <span class="lang-arabic">الالتزام بالتحسين المستمر</span>
                    </div>
                    <div class="mt-2 text-base leading-7 text-textSecondary lang-english hidden">
